...
MORTALITY_MULTIPLIER_US_REOPEN = 0.990 # faster rate of IFR decrease in the US after reopening
...
DAYS_IN_HOSPITAL = 11
## Vaccine related params
HOSPITALIZATION_RATE_1ST_DOSE = HOSPITALIZATION_RATE*0.05
HOSPITALIZATION_RATE_2ND_DOSE = HOSPITALIZATION_RATE*0.005
DOSE1_EFFICACY = 0.7
DOSE2_EFFICACY = 0.95
##
DAYS_BEFORE_DEATH = 22 # 22 after exposure, from https://doi.org/10.3390/jcm9020538
IMMUNITY_MULTIPLIER = 2 #0.5
IMMUNITY_MULTIPLIER_US_SUBREGION = 0.3
DAYS_UNTIL_LOCKDOWN_FATIGUE = 28
DAYS_WITH_IMPORTS = 110
